...
export const updateStudyGoal = (id, payload) => api(`/api/study/goals/${encodeURIComponent(id)}`, { method: "PATCH", body: JSON.stringify(payload) });
export const generateStudyPlan = (id, payload = {}) => api(`/api/study/goals/${encodeURIComponent(id)}/generate-plan`, { method: "POST", body: JSON.stringify(payload) });
export const getStudyPlan = (id, params = {}) => api(`/api/study/goals/${encodeURIComponent(id)}/plan?${new URLSearchParams(params)}`);
export const updateStudyPlanItem = (id, payload) => api(`/api/study/plan-items/${encodeURIComponent(id)}`, { method: "PATCH", body: JSON.stringify(payload) });
...
export const reviewFlashcard = (id, grade) => api(`/api/flashcards/${id}/review`, { method: "POST", body: JSON.stringify({ grade }) });
export const deleteFlashcard = (id) => api(`/api/flashcards/${id}`, { method: "DELETE" });
export const generateFlashcards = (payload) => api("/api/flashcards/generate", { method: "POST", body: JSON.stringify(payload) });

export const getDataAiCurriculum = () => api("/api/data-ai/curriculum");
export const completeDataAiLesson = (id) => api(`/api/data-ai/lessons/${encodeURIComponent(id)}/complete`, { method: "POST", body: "{}" });
export const submitDataAiCheck = (id, selectedIndex) => api(`/api/data-ai/checks/${encodeURIComponent(id)}/submit`, { method: "POST", body: JSON.stringify({ selected_index: selectedIndex }) });
