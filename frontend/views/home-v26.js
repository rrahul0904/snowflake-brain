...
export default async function mount(container, params = {}) {
  ...
  container.innerHTML = `<main class="v26-page v26-home"><section class="v26-home-hero"><p class="v26-kicker">SnowPro Core · ${cert.exam_code || "COF-C03"}</p><h1>Practise until you <em>pass.</em></h1><p class="v26-lede">A focused Snowflake certification guide built around the current exam blueprint, written task lessons, deliberate practice, and timed mocks.</p><div class="v26-hero-actions"><a class="v26-btn primary" href="#/curriculum?track_id=${encodeURIComponent(cert.id)}">Start learning</a><a class="v26-btn secondary" href="#/mock?track_id=${encodeURIComponent(cert.id)}">Take a mock exam</a></div><div class="v26-proof"><span>${domains.length || 5} domains</span><i></i><span>${tasks} task statements</span><i></i><span>${progress.completed_tasks || 0}/${progress.total_tasks || tasks} completed</span></div><div id="v26-home-globe" class="v26-home-globe"></div></section></main>`;
