...
export default async function mount(container, params = {}) {
  ...
  container.innerHTML = `<main class="v26-page v26-home"><section class="v26-home-hero"><p class="v26-kicker">SnowPro Core certification · ${cert.exam_code || "COF-C03"}</p><h1>Practise until you <em>pass.</em></h1><p class="v26-lede">Prepare with a complete written curriculum behind every timed mock: learn the Snowflake blueprint, repair weak tasks, then rehearse the exam experience.</p><div class="v26-hero-actions"><a class="v26-btn primary" href="#/certifications">Choose your certification</a><a class="v26-btn secondary" href="#/curriculum?track_id=${encodeURIComponent(cert.id)}">Explore the curriculum</a></div><div class="v26-proof"><span>Blueprint-first preparation across ${domains.length || 5} domains · ${tasks} task statements</span></div><div id="v26-home-globe" class="v26-home-globe"></div></section></main>`;
