...
export default async function render(root,params={}){
 ...
 <section class="v26-section"><div class="v26-practice-grid">
   ...
   <a class="v26-practice-card" href="#/daily-session?track_id=${encodeURIComponent(track)}"><span>Blitz</span><h2>Daily Recall</h2><p>Use the integrated Clouding Academy daily loop for fast active recall before recognition-based practice.</p><div><b>Daily loop</b><em>Open →</em></div></a>
